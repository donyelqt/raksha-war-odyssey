...
const P2HeroSelection: React.FC = () => {
    ...
    return (
        <div className='flex w-full h-screen'>
            ...
            <div className="flex flex-col items-center justify-center w-1/2 p-8 bg-gray-100 min-h-screen">
                <h1 className="text-xl font-bold p-2 rounded-lg text-red-600 mb-4">Player 2's turn to pick (Blue Celestials)</h1>
                        ...
                        {heroes.map((hero) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`mt-4 px-6 py-2 text-sm text-white rounded-lg transition-colors duration-200 ${
...
export default P2HeroSelection;